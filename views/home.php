        ...
        <section id="hero" class="hero-grid">
            ...
            <div class="hero-side">
                <div class="category-card card-cyan">
                    ...
                    <img src="public/img/cat_food.svg" class="cat-img" loading="lazy" style="width: 80px; height: 80px; object-fit: contain;">
                </div>
                <div class="category-card card-blue-light">
                    ...
                    <img src="public/img/cat_drink.svg" class="cat-img" loading="lazy" style="width: 80px; height: 80px; object-fit: contain;">
                </div>
            </div>
        </section>
                        ...
                        <div class="swiper-slide">
                            <div class="prod-card-fixed">
                                <div class="prod-circle-img">
                                    <img src="uploads/<?= $prod['gambar'] ?>" alt="Produk" onerror="this.src='public/img/default-food.svg'" loading="lazy">
                                </div>
